...
class ManagersControllerTest < ActionController::TestCase
  ...
  test "should create manager" do
    assert_difference('Manager.count') do
      post :create, manager: { format: @manager.format, length: @manager.length, name: @manager.name, size: @manager.size, sizeDescription: @manager.sizeDescription }
    end
  ...
  test "should update manager" do
    patch :update, id: @manager, manager: { format: @manager.format, length: @manager.length, name: @manager.name, size: @manager.size, sizeDescription: @manager.sizeDescription }
    assert_redirected_to manager_path(assigns(:manager))
  end
